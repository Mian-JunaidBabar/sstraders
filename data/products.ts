...
export const ferro: Product[] = [
  {
    name: "Ferro Silicon 72%",
    slug: "ferro-silicon-72",
    category: "ferro",
    use: "Steel deoxidation",
    status: "Ready stock",
    photo: P + "ferro-silicon-72.webp",
    note: "Fresh stock available. 72% grade, high purity, ready for immediate delivery.",
    origin: "China",
    specs: [
      { k: "Si", v: "72%" },
      { k: "Size", v: "10 – 50 mm" },
...
export const masterAlloys: Product[] = [
  ...
  },
  {
    ...
    note: "AlTi5B1 master alloy rod / coil. Premier grain refiner for continuous casting and billet extrusion.",
    origin: "China",
    specs: [
      { k: "Ti", v: "5.0%" },
      { k: "B", v: "1.0%" },
...
export const metals: Product[] = [
  {
    ...
    slug: "silicon-metal-553",
    category: "metals",
    use: "Si addition, aluminium",
    status: "Ready stock",
    photo: P + "silicon-metal-441.webp",
    note: "High-purity silicon metal 553 grade. Stock available in warehouse for immediate delivery.",
    origin: "China",
    specs: [
      { k: "Si min", v: "98.5%" },
      { k: "Fe / Al / Ca max", v: "0.5% / 0.5% / 0.3%" },
      { k: "Size", v: "10 – 100 mm lump" },
      { k: "Packing", v: "1 MT jumbo bag" },
    ],
    chem: [
      { k: "Silicon (Si) min", v: "98.5%" },
      { k: "Iron (Fe) max", v: "0.5%" },
      { k: "Aluminium (Al) max", v: "0.5%" },
      { k: "Calcium (Ca) max", v: "0.3%" },
    ],
    supply: [
      { k: "Grade", v: "Si Metal 553" },
  ...
  },
  {
    ...
    note: "High-purity 99.9% nickel ingot/cathode. Ready stock available for alloying and electroplating.",
    origin: "China / Russia",
    specs: [
      { k: "Ni min", v: "99.9%" },
    ...
    chem: [
      { k: "Nickel (Ni) min", v: "99.9%" },
      { k: "Cobalt (Co) max", v: "0.05%" },
      { k: "Carbon (C) max", v: "0.02%" },
      { k: "Sulphur (S) max", v: "0.01%" },
    ],
    supply: [
      { k: "Grade", v: "Pure Nickel (99.9%)" },
      { k: "Form", v: "Ingot / Cathode cut" },
      { k: "Packing", v: "Steel strapped pallet / Drum" },
      { k: "Origin", v: "China / Russia" },
      { k: "Minimum order", v: "100 kg" },
      { k: "Delivery", v: "Ex-Lahore, 24 – 72 hrs" },
    ],
    uses: [
  ...
  },
  {
    ...
    note: "High-purity 99.9% tin ingot. Ready stock available for solder, bronze alloys, and coatings.",
    ...
    chem: [
      { k: "Tin (Sn) min", v: "99.9%" },
      { k: "Lead (Pb) max", v: "0.02%" },
      { k: "Copper (Cu) max", v: "0.01%" },
      { k: "Bismuth (Bi) max", v: "0.01%" },
    ],
    supply: [
      { k: "Grade", v: "Pure Tin Ingot (99.9%)" },
      { k: "Form", v: "Ingot (~25 kg)" },
      { k: "Packing", v: "Steel strapped pallet" },
      { k: "Origin", v: "Malaysia / Indonesia" },
      { k: "Minimum order", v: "100 kg" },
      { k: "Delivery", v: "Ex-Lahore, 24 – 72 hrs" },
    ],
    uses: [
  ...
  },
  {
    ...
    note: "High-purity 99.9% zinc ingot. Ready stock available for galvanising, die casting, and brass manufacturing.",
    origin: "Kazakhstan / China",
    specs: [
      { k: "Zn min", v: "99.9%" },
      { k: "Form", v: "Ingot" },
    ],
    chem: [
      { k: "Zinc (Zn) min", v: "99.9%" },
      { k: "Lead (Pb) max", v: "0.005%" },
      { k: "Iron (Fe) max", v: "0.005%" },
      { k: "Cadmium (Cd) max", v: "0.003%" },
    ],
    supply: [
      { k: "Grade", v: "High Grade Zinc (99.9%)" },
      { k: "Form", v: "Ingot (~25 kg)" },
      { k: "Packing", v: "1 MT pallet" },
      { k: "Origin", v: "Kazakhstan / China" },
      { k: "Minimum order", v: "500 kg" },
      { k: "Delivery", v: "Ex-Lahore, 24 – 72 hrs" },
    ],
    uses: [
  ...
  },
  {
    ...
    note: "High-purity 99.9% magnesium ingot. Ready stock available for aluminium alloying, desulphurization, and nodularising.",
    origin: "China",
    specs: [
      { k: "Mg min", v: "99.9%" },
      { k: "Form", v: "Ingot" },
    ...
    chem: [
      { k: "Magnesium (Mg) min", v: "99.9%" },
      { k: "Silicon (Si) max", v: "0.05%" },
      { k: "Iron (Fe) max", v: "0.04%" },
      { k: "Aluminium (Al) max", v: "0.02%" },
    ],
    supply: [
      { k: "Grade", v: "Pure Magnesium Ingot (99.9%)" },
  ...
  },
  {
    ...
    note: "High-purity 99.9% cadmium ingot/stick. Available for plating and specialty alloy manufacturing.",
    origin: "China / Kazakhstan",
    specs: [
      { k: "Cd min", v: "99.9%" },
      { k: "Form", v: "Ingot / stick" },
    ],
    chem: [
      { k: "Cadmium (Cd) min", v: "99.9%" },
      { k: "Lead (Pb) max", v: "0.02%" },
      { k: "Zinc (Zn) max", v: "0.01%" },
      { k: "Iron (Fe) max", v: "0.005%" },
    ],
    supply: [
      { k: "Grade", v: "Pure Cadmium (99.9%)" },
      { k: "Form", v: "Ingot / Stick" },
      { k: "Packing", v: "Sealed drum / pallet" },
      { k: "Origin", v: "China / Kazakhstan" },
      { k: "Minimum order", v: "100 kg" },
      { k: "Delivery", v: "Ex-Lahore, 24 – 72 hrs" },
    ],
    uses: [
...
const rawFluxes = [
  {
    name: "Covering Flux",
    use: "Aluminium melting",
    status: "Ready stock",
    photo: P + "cover-flux.webp",
    note: "High-performance covering flux for aluminium melting. Forms a protective barrier to minimize oxidation loss and dross formation.",
    origin: "China",
    specs: [
      { k: "Use", v: "Aluminium melting" },
      { k: "Form", v: "Powder / Granular" },
      { k: "Dosage", v: "0.5 – 1.0% by melt weight" },
      { k: "Application", v: "Melting & holding stage" },
    ],
    chem: [
      { k: "Target melt", v: "Aluminium & alloys" },
      { k: "Base composition", v: "Chloride-fluoride blend" },
      { k: "Moisture max", v: "0.5%" },
    ],
    supply: [
      { k: "Form", v: "Powder / Granular" },
      { k: "Packing", v: "25 kg moisture-proof bag" },
      { k: "Origin", v: "China" },
      { k: "Minimum order", v: "100 kg" },
      { k: "Delivery", v: "Ex-Lahore, 24 – 72 hrs" },
    ],
...
export const ranges: Range[] = [
  {
    ...
    photo: P + "ferro-silicon.webp",
    chips: ["FeSi 72%", "FeMn 75%", "FeCr 60%", "Pig Iron"],
  },
  {
    kicker: "Stock in warehouse",
    title: "Non-Ferro Alloys",
    body: "Non-ferrous foundry additives including Copper Phosphorus deoxidisers.",
    photo: P + "copper-phosphorus.webp",
    chips: ["CuP 14%", "Deoxidiser", "Ready stock"],
  },
  {
  ...
  {
    kicker: "2 formulations",
    title: "Fluxes",
    body: "Melt surface protection and hydrogen degasser tablets.",
    photo: P + "cover-flux.webp",
    chips: ["Covering Flux", "Degasser Tablets", "Ready stock"],
  },
  {
    kicker: "All sizes",
