  ...
  return (
    <>
      ...
      >
        ...
        >
          Direct imported ferro alloys for steel foundries, grey iron, ductile
          iron and alloy steel casting units across Pakistan. Lab tested with
          lot-wise COA available with every quotation.
        </p>
